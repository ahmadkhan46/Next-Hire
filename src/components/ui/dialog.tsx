  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid max-h-[calc(100dvh-1rem)] w-[calc(100%-0.75rem)] max-w-[calc(100%-0.75rem)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto rounded-2xl border p-3 shadow-lg duration-200 outline-none inner-scroll sm:max-h-[calc(100dvh-2rem)] sm:w-full sm:max-w-lg sm:p-6",
          className
        )}
        {...props}
      >
