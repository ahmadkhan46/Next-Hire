      ...
      <div className="relative z-10 w-full max-w-md px-4 sm:px-6">
        ...
        <div className="tech-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 overflow-hidden">
          <div className="mb-6 text-center">
            <h1 className="text-2xl sm:text-3xl font-black tech-title mb-1.5">Welcome back</h1>
            <p className="tech-muted text-sm">Sign in to your workspace</p>
          </div>
          ...
          <div className="rounded-xl tech-auth">
            {clerkEnabled ? (
              ...
              <div className="rounded-xl border border-amber-300/30 bg-amber-100/10 p-4 text-left text-sm text-slate-200">
                Sign-in is temporarily unavailable because Clerk is not configured in this deployment.
              </div>
            )}
          </div>
          ...
          <p className="mt-5 text-center text-sm text-slate-400">
            ...
            <Link href="/sign-up" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
